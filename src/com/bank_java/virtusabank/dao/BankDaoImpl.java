package com.bank_java.virtusabank.dao;

import com.bank_java.virtusabank.model.Accounts;
import com.bank_java.virtusabank.util.ConnectionHelper;
...
public class BankDaoImpl implements BankDao {
  ...
  public String getStatus(int accno) throws SQLException, ClassNotFoundException {
    conn = ConnectionHelper.getConnection();
  ...
  public String updateAccount(int accountNo, String city, String state) throws SQLException, ClassNotFoundException {
    ...
    if (accountFound != null){
      String status = getStatus(accountNo);
      if(status.equals("inactive")){
        return "Account no.: "+accountNo +" is inactive. Please check no. or Activate to update.";
      }
      conn = ConnectionHelper.getConnection();
  ...
  public String closeAccount(int accountNo) throws SQLException, ClassNotFoundException {
    ...
    if (account != null){
      String status = getStatus(accountNo);
      if(status.equals("inactive")){
        return "Account No.: "+accountNo+" already inactive.";
      }
      conn = ConnectionHelper.getConnection();
  ...
  public String depositAccount(int accountNo, double amount) throws SQLException, ClassNotFoundException {
    ...
    if (accounts !=null){
      String status = getStatus(accountNo);
      if(status.equals("inactive")){
        return "Account No.: "+accountNo+" is inactive. Cannot deposit!!";
      }
      conn = ConnectionHelper.getConnection();
  ...
  public String withdrawAccount(int accountNo, double amount) throws SQLException, ClassNotFoundException {
    ...
    if (accounts != null){
      String status = getStatus(accountNo);
      if(status.equals("inactive")){
        return "Account No.: "+accountNo+" inactive. Cannot withdraw!!";
      }
